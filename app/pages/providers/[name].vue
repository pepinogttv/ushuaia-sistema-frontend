    ...
    <v-card>
      ...
      <v-card-text class="pa-6">
        <v-alert type="info" variant="tonal" class="mb-4">
          Estás viendo la información del proveedor: <strong>{{ providerName }}</strong>
        </v-alert>
        ...
        <div class="mt-6">
          ...
          <div v-else-if="providerSources.length === 0" class="text-center pa-4">
            <p class="text-grey">No hay fuentes disponibles para este proveedor</p>
          </div>
          ...
          <v-list v-else lines="two">
            ...
            >
              ...
              <template v-slot:prepend>
                <v-icon 
                  :icon="source.type === 'file' ? 'mdi-file-document' : 'mdi-web'" 
                  color="primary"
                />
              </template>
            </v-list-item>
